...
| 3 | Manifest support (step 4) | #267 | planned | Re-scoped: a general ROS 2 manifest resolver (temporary home in this repo, built for extraction) that the ros2_colcon adapter calls; dual prototype (own resolver vs west) decides the tool; vcs2l replaces vcstool for fetching |
