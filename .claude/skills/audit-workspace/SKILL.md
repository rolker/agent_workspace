...
**Not the same as a structural validation script** — those scripts check
structural config (repos match config files, projects are set up correctly).
This skill checks governance: are rules enforced? Are docs current? Are ADRs
still accurate?
